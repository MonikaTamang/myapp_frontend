...
export class EditMemModal extends Component{
    constructor(props){
        super(props);
        this.state={deps:[]};
    ...
    handleFileSelected(event){
        ...
        fetch(process.env.REACT_APP_API+'member/SaveFile',{
            method:'POST',
            body:formData
        })
        .then(res=>res.json())
